...
- **Agent Onboarding System (December 2025)**: Streamlined team leader onboarding workflow for new agents. Team leaders can submit onboarding requests with simplified agent fields (firstName, lastName, email, username, password, division/department/section). Requests are submitted for manager approval, and upon approval, agents are automatically created and assigned to the onboarding team leader's team. Features include: simplified form with cascading hierarchy selects, manager approval/rejection workflow with rejection reasons, automatic team assignment, comprehensive notifications to team leaders and managers, and request tracking.
